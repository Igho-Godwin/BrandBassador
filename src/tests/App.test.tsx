...
describe('Test Case For App', () => {
  it('should render mission feeds component', () => {
    ...
    const wrapper = mount(<ApolloProvider client={client}><I18nextProvider i18n={i18next}><MissionFeeds /></I18nextProvider></ApolloProvider>)
  ...
  it('should render Feed Item component', () => {
    ...
    const wrapper = mount(<I18nextProvider i18n={i18next}><FeedItemComp item={item} /></I18nextProvider>)
